...
;
Drupal.locale = { 'pluralFormula': function($n) { return Number(($n>1)); }, 'strings': { "Unspecified error": "Error no especificado", "Drag to re-order": "Arrastre para reordenar", "Changes made in this table will not be saved until the form is submitted.": "Los cambios realizados en esta tabla no se guardarán hasta que se envíe el formulario", "The changes to these blocks will not be saved until the \x3cem\x3eSave blocks\x3c/em\x3e button is clicked.": "Los cambios sobre estos bloques no se guardarán hasta que no pulse el botón \x3cem\x3eGuardar bloques\x3c/em\x3e.", "Automatic alias": "Alias automático de ruta", "Clear": "Borrar", "Cancel": "Cancelar", "Name": "Nombre", "Submit": "Enviar", "Testing clean URLs...": "Probando URL limpias...", "Your server has been successfully tested to support this feature.": "Se ha comprobado que su servidor admite sin problemas esta opción.", "Your system configuration does not currently support this feature. The \x3ca href=\"http://drupal.org/node/15365\"\x3ehandbook page on Clean URLs\x3c/a\x3e has additional troubleshooting information.": "La configuración de su sistema no admite actualmente esta característica. La \x3ca href=\"http://drupal.org/node/15365\"\x3epágina del manual sobre URL limpias\x3c/a\x3e tiene más información sobre posibles problemas.", "Split summary at cursor": "Definir resumen hasta el cursor", "Join summary": "Unir resumen", "file": "archivo", "language": "idioma", "Select all rows in this table": "Seleccionar todas las filas de esta tabla", "Deselect all rows in this table": "Quitar la selección a todas las filas de esta tabla", "Size": "Tamaño", "Search": "Buscar", "Upload": "Subir", "Reset": "Reiniciar", "Only files with the following extensions are allowed: %files-allowed.": "Sólo se permiten archivos con las siguientes extensiones: %files-allowed." } };;
/*
...
(function($){$.fn.hoverIntent=function(f,g){var cfg={sensitivity:7,interval:100,timeout:0};cfg=$.extend(cfg,g?{over:f,out:g}:f);var cX,cY,pX,pY;var track=function(ev){cX=ev.pageX;cY=ev.pageY};var compare=function(ev,ob){ob.hoverIntent_t=clearTimeout(ob.hoverIntent_t);if((Math.abs(pX-cX)+Math.abs(pY-cY))<cfg.sensitivity){$(ob).unbind("mousemove",track);ob.hoverIntent_s=1;return cfg.over.apply(ob,[ev])}else{pX=cX;pY=cY;ob.hoverIntent_t=setTimeout(function(){compare(ev,ob)},cfg.interval)}};var delay=function(ev,ob){ob.hoverIntent_t=clearTimeout(ob.hoverIntent_t);ob.hoverIntent_s=0;return cfg.out.apply(ob,[ev])};var handleHover=function(e){var ev=jQuery.extend({},e);var ob=this;if(ob.hoverIntent_t){ob.hoverIntent_t=clearTimeout(ob.hoverIntent_t)}if(e.type=="mouseenter"){pX=ev.pageX;pY=ev.pageY;$(ob).bind("mousemove",track);if(ob.hoverIntent_s!=1){ob.hoverIntent_t=setTimeout(function(){compare(ev,ob)},cfg.interval)}}else{$(ob).unbind("mousemove",track);if(ob.hoverIntent_s==1){ob.hoverIntent_t=setTimeout(function(){delay(ev,ob)},cfg.timeout)}}};return this.bind('mouseenter',handleHover).bind('mouseleave',handleHover)}})(jQuery);(function($,h,c){var a=$([]),e=$.resize=$.extend($.resize,{}),i,k="setTimeout",j="resize",d=j+"-special-event",b="delay",f="throttleWindow";e[b]=250;e[f]=true;$.event.special[j]={setup:function(){if(!e[f]&&this[k]){return false}var l=$(this);a=a.add(l);$.data(this,d,{w:l.width(),h:l.height()});if(a.length===1){g()}},teardown:function(){if(!e[f]&&this[k]){return false}var l=$(this);a=a.not(l);l.removeData(d);if(!a.length){clearTimeout(i)}},add:function(l){if(!e[f]&&this[k]){return false}var n;function m(s,o,p){var q=$(this),r=$.data(this,d);r.w=o!==c?o:q.width();r.h=p!==c?p:q.height();n.apply(this,arguments)}if($.isFunction(l)){n=l;return m}else{n=l.handler;l.handler=m}}};function g(){i=h[k](function(){a.each(function(){var n=$(this),m=n.width(),l=n.height(),o=$.data(this,d);if(m!==o.w||l!==o.h){n.trigger(j,[o.w=m,o.h=l])}});g()},e[b])}})(jQuery,this);jQuery.easing['jswing']=jQuery.easing['swing'];jQuery.extend(jQuery.easing,{def:'easeOutQuad',swing:function(x,t,b,c,d){return jQuery.easing[jQuery.easing.def](x,t,b,c,d);},easeInQuad:function(x,t,b,c,d){return c*(t/=d)*t+b;},easeOutQuad:function(x,t,b,c,d){return-c*(t/=d)*(t-2)+b;},easeInOutQuad:function(x,t,b,c,d){if((t/=d/2)<1)return c/2*t*t+b;return-c/2*((--t)*(t-2)-1)+b;},easeInCubic:function(x,t,b,c,d){return c*(t/=d)*t*t+b;},easeOutCubic:function(x,t,b,c,d){return c*((t=t/d-1)*t*t+1)+b;},easeInOutCubic:function(x,t,b,c,d){if((t/=d/2)<1)return c/2*t*t*t+b;return c/2*((t-=2)*t*t+2)+b;},easeInQuart:function(x,t,b,c,d){return c*(t/=d)*t*t*t+b;},easeOutQuart:function(x,t,b,c,d){return-c*((t=t/d-1)*t*t*t-1)+b;},easeInOutQuart:function(x,t,b,c,d){if((t/=d/2)<1)return c/2*t*t*t*t+b;return-c/2*((t-=2)*t*t*t-2)+b;},easeInQuint:function(x,t,b,c,d){return c*(t/=d)*t*t*t*t+b;},easeOutQuint:function(x,t,b,c,d){return c*((t=t/d-1)*t*t*t*t+1)+b;},easeInOutQuint:function(x,t,b,c,d){if((t/=d/2)<1)return c/2*t*t*t*t*t+b;return c/2*((t-=2)*t*t*t*t+2)+b;},easeInSine:function(x,t,b,c,d){return-c*Math.cos(t/d*(Math.PI/2))+c+b;},easeOutSine:function(x,t,b,c,d){return c*Math.sin(t/d*(Math.PI/2))+b;},easeInOutSine:function(x,t,b,c,d){return-c/2*(Math.cos(Math.PI*t/d)-1)+b;},easeInExpo:function(x,t,b,c,d){return(t==0)?b:c*Math.pow(2,10*(t/d-1))+b;},easeOutExpo:function(x,t,b,c,d){return(t==d)?b+c:c*(-Math.pow(2,-10*t/d)+1)+b;},easeInOutExpo:function(x,t,b,c,d){if(t==0)return b;if(t==d)return b+c;if((t/=d/2)<1)return c/2*Math.pow(2,10*(t-1))+b;return c/2*(-Math.pow(2,-10*--t)+2)+b;},easeInCirc:function(x,t,b,c,d){return-c*(Math.sqrt(1-(t/=d)*t)-1)+b;},easeOutCirc:function(x,t,b,c,d){return c*Math.sqrt(1-(t=t/d-1)*t)+b;},easeInOutCirc:function(x,t,b,c,d){if((t/=d/2)<1)return-c/2*(Math.sqrt(1-t*t)-1)+b;return c/2*(Math.sqrt(1-(t-=2)*t)+1)+b;},easeInElastic:function(x,t,b,c,d){var s=1.70158;var p=0;var a=c;if(t==0)return b;if((t/=d)==1)return b+c;if(!p)p=d*.3;if(a<Math.abs(c)){a=c;var s=p/4;}
else var s=p/(2*Math.PI)*Math.asin(c/a);return-(a*Math.pow(2,10*(t-=1))*Math.sin((t*d-s)*(2*Math.PI)/p))+b;},easeOutElastic:function(x,t,b,c,d){var s=1.70158;var p=0;var a=c;if(t==0)return b;if((t/=d)==1)return b+c;if(!p)p=d*.3;if(a<Math.abs(c)){a=c;var s=p/4;}
else var s=p/(2*Math.PI)*Math.asin(c/a);return a*Math.pow(2,-10*t)*Math.sin((t*d-s)*(2*Math.PI)/p)+c+b;},easeOutElasticBURO:function(x,t,b,c,d){var s=1.70158;var p=0;var a=c;if(t==0)return b;if((t/=d)==1)return b+c;if(!p)p=d*.7;if(a<Math.abs(c)){a=c;var s=p/4;}
...
/*cap*/
jQuery.fn.extend({captify:function(n){var a=$.extend({speedOver:"fast",speedOut:"normal",hideDelay:500,animation:"slide",prefix:"",opacity:"0.45",className:"caption-bottom",position:"bottom",spanWidth:"90px"},n);$(this).each(function(){var c=this;$(this).load(function(){if(c.hasInit)return false;c.hasInit=true;var i=false,k=false,e=$("#"+$(this).attr("rel")),g=!e.length?$(this).attr("alt"):e.html();e.remove();e=this.parent&&this.parent.tagName=="a"?this.parent:$(this);var h=e.wrap("<div></div>").parent().css({overflow:"hidden",
...
$(document).ready(function(){$('input[type=text]').each(function(){var aux=$(this).attr("class");if(aux!="textclean")return;var defalt=this.defaultValue;$(this).focus(function(){if($(this).val()==defalt){$(this).val("")}});$(this).blur(function(){if($(this).val()==""){$(this).val(defalt)}});});});
function sf(){$("ul.sf-menu").superfish();}
function sli(){$('img.captify').captify({});}
document.onclick=function(e){var target=e?e.target:window.event.srcElement;while(target&&!/^(a|body)$/i.test(target.nodeName)){target=target.parentNode}if(target&&target.getAttribute("rel")&&target.rel=="external"){var linkExterno=window.open(target.href);return linkExterno.closed}}

function tabss(){(function(){var $tabs=$('.tabss li a');var items=$tabs.map(function(el){return $('#'+$(this).attr('rel')).get(0)});$tabs.bind('click',function(e){e.preventDefault();$tabs.removeClass('currentt');$(items).removeClass('activet');var $this=$(this);$('#'+$this.attr('rel')).css('display','none').addClass('activet').fadeIn('slow');$this.addClass('currentt')});$tabs.hover(function(){$(this).addClass('hover')},function(){$(this).removeClass('hover')})})()}

$(document).ready(function(){if($.browser.msie && parseInt($.browser.version, 10) < 7 ){window.location.href = "/error-ie6/"}$("a[rel=external]").click(function(){var linkExterno=window.open($(this).attr("href"));return linkExterno.closed});$("a[rel=print]").click(function(){var imprimir=window.print();return false})})

$(document).ready(function(){$('.cleantxt').focus(function(){if($(this).val()==this.defaultValue){$(this).val("")}});$('.cleantxt').blur(function(){if($(this).val()==""){$(this).val(this.defaultValue)}})});

$(document).ready(function(){$("#slideshow li img").parent().css("zIndex","1");$("#slideshow li:gt(0) img").css("left",1500).fadeTo(10,0).hide().parent().css("z-index","0");$("#slideshow li:gt(0) div").css("left",2000).fadeTo(10,0).hide();global_NmaxSlide=$("#slideshow li").size();global_Nslide=0;global_click=0;startAnimSlide();$("#snext, #sprev").click(function(){stopAnimSlide()});$("#snext").click(function(){tempoAnimSlide('next')});$("#sprev").click(function(){tempoAnimSlide('prev')});$("#contentw").hover(function(){$("#snext,#sprev").animate({"opacity":"1"},"fast")},function(){$("#snext,#sprev").animate({"opacity":"0"},"slow")})});

function startAnimSlide(){global_meuSetIntervalSlide=setInterval("tempoAnimSlide('next')",6000)}
function stopAnimSlide(){clearInterval(global_meuSetIntervalSlide)}

function tempoAnimSlide(direction){if(direction=="next"){if(global_Nslide==(global_NmaxSlide-1)){global_Nslide=0;global_click=0;auxImg1=$("#slideshow li img")[global_NmaxSlide-1];auxTxt1=$("#slideshow li div")[global_NmaxSlide-1];fNext()}else{global_Nslide+=1;global_click+=1;auxImg1=$("#slideshow li img")[global_click-1];auxTxt1=$("#slideshow li div")[global_click-1];fNext()}}else{if(global_Nslide==0){auxImg=$("#slideshow li img")[0];auxTxt=$("#slideshow li div")[0];global_Nslide=(global_NmaxSlide-1);global_click=(global_NmaxSlide-1);auxImg1=$("#slideshow li img")[global_click];auxTxt1=$("#slideshow li div")[global_click];fPrev()}else{auxImg=$("#slideshow li img")[global_click];auxTxt=$("#slideshow li div")[global_click];global_Nslide-=1;global_click-=1;auxImg1=$("#slideshow li img")[global_click];auxTxt1=$("#slideshow li div")[global_click];fPrev()}}}

function fNext(){auxImg=$("#slideshow li img")[global_click];auxTxt=$("#slideshow li div")[global_click];$(auxImg).parent().css("z-index","1");$(auxImg1).parent().css("z-index","0");$(auxImg).css("left",1500).fadeTo(10,0).hide();$(auxTxt).css("left",2000).fadeTo(10,0).hide();$(auxImg).stop().animate({"left":33,"opacity":1},1200,"easeOutCubic").show();$(auxTxt).stop().animate({"left":420,"opacity":1},1350,"easeOutCubic").show();$(auxImg1).stop().animate({"left":-1500,"opacity":0},400,"easeInCubic",function(){$(this).css("left",1500).hide()});$(auxTxt1).stop().animate({"left":-1500,"opacity":0},600,"easeInCubic",function(){$(this).css("left",2000).hide()})}

function fPrev(){$(auxImg1).parent().css("z-index","1");$(auxImg).parent().css("z-index","0");$(auxImg1).css("left",-2000).fadeTo(10,0).hide();$(auxTxt1).css("left",-1500).fadeTo(10,0).hide();$(auxImg1).stop().animate({"left":33,"opacity":1},1350,"easeOutCubic").show();$(auxTxt1).stop().animate({"left":420,"opacity":1},1200,"easeOutCubic").show();$(auxImg).stop().animate({"left":1500,"opacity":0},600,"easeInCubic",function(){$(this).css("left",-1500).hide()});$(auxTxt).stop().animate({"left":1500,"opacity":0},400,"easeInCubic",function(){$(this).css("left",-1500).hide()})}



$(function(){var input=$('input#sf');var divInput=$('div.input');var width=divInput.width();var outerWidth=divInput.parent().width()-(divInput.outerWidth()-width)-28;var submit=$('#submit');var txt=input.val();input.bind('focus',function(){if(input.val()===txt){input.val('')}$(this).animate({color:'#000'},300);$(this).parent().animate({width:outerWidth+'px',backgroundColor:'#fff',paddingRight:'43px'},300,function(){if(!(input.val()===''||input.val()===txt)){if(!($.browser.msie&&$.browser.version<9)){submit.fadeIn(300)}else{submit.css({display:'block'})}}}).addClass('focus')}).bind('blur',function(){$(this).animate({color:'#b4bdc4'},300);$(this).parent().animate({width:width+'px',backgroundColor:'#e8edf1',paddingRight:'15px'},300,function(){if(input.val()===''){input.val(txt)}}).removeClass('focus');if(!($.browser.msie&&$.browser.version<9)){submit.fadeOut(100)}else{submit.css({display:'none'})}}).keyup(function(){if(input.val()===''){if(!($.browser.msie&&$.browser.version<9)){submit.fadeOut(300)}else{submit.css({display:'none'})}}else{if(!($.browser.msie&&$.browser.version<9)){submit.fadeIn(300)}else{submit.css({display:'block'})}}})});

/*$("#foo").append("<div>hello world</div>")*/
/*$(function() {
  $(".node").each(function() {
    $(this).find("p:first").append("<div class='clear'></div>");
  });
});*/

$(document).ready(function(){sf();sli();tabss();
  $('#search-theme-form').submit(function(e){
    if($('#sf').val() == ''){
      e.preventDefault();
      alert('Debe introducir al menos una palabra para poder buscar');
      $('#sf').trigger( 'focus' );
    }
  });

  $('.imagefield-imagelink').colorbox();
  
});
 $(window).load(function () {
        $("#slideshow li,p#next,p#prev")./*css("display","block").*/fadeIn('slow');
    });
/*$(document).ready(function(){
        $("li a, p").hide();
     });
...
{
      $(".lang").on('touchstart', function(){ 
           console.log("touch started");
      });
      $(".lang").on('touchend', function(){
           console.log("touch ended");
      });
}*/

$(document).ready(function(){$('.fotos-tecnicas img').jcaption();});

$(document).ready(function(){
 
    var $curr = $(".frby");
      $curr = $curr.next().css("position", "fixed");
	


//para addthis img, bueno.
/*$("img.imagefield").addClass("addthis_shareable");
$(".imagefield").attr("addthis:url","http://www.addthis.com/labs/photo-sharing");*/
 
/* $("ul.links li:last-child").addClass("last-child"); na*/

/* enhance({loadStyles:['/sites/default/themes/amperis/css/style.css'],loadScripts:['plugins.js','hi.js','sf.js','resp.js','jcaption.min.js','index.js'],forcePassText:'Versi&oacute;n mejorada',forceFailText:'Versi&oacute;n b&aacute;sica'});*/
  });
;
