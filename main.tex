...
\include{content/sobre-las-mediciones}
\include{content/errores}

\include{content/magnitudes-electricas}

\include{content/alterna}
\include{content/polifasicos}

\include{content/instrumentos}

\include{content/maquinas}

\include{content/practicas}
% opcional: transitorios en L y C, generación de CA, motores eléctricos
